...
# ==============================================================================================
#  3. Scenario 1,0: Genetic effect difference Δβɢx ≠ 0 and no causal effect difference Δβxʏ = 0 
# ==============================================================================================
...
## Same scenarios as in 00 for each Δβɢx
...
for(i in 1:length(diff_BGXs)){
  ...
  temp$main_scenario_val <- paste0("diff_BGX=",diff_BGXs[i])
  
  scenarios10 <- rbind(scenarios10, temp)
}

scenarios10$main_scenario <- "scenario.10"

scenarios10[, 5:14] <- apply(scenarios10[, 5:14] , 2, as.numeric)
save(scenarios10, file = paste0(out_dir, "/scenario.10.Rdata"))
write.table(scenarios10, file = paste0(out_dir, "/scenario.10.csv"), col.names = F, row.names = F, quote = F, na = "NA", sep = "\t")
